...
class Background_Thumbnails_Regeneration extends Base_Filter
{
    public function listen()
    {
        ...
        add_filter('woocommerce_background_image_regeneration', [$this, 'disableWooCommerceBackgroundRegeneration']);
    }
    ...
    public function disableWooCommerceBackgroundRegeneration(){
       return apply_filters('wp_sir_enable_background_thumbnails_regeneration', false);
    }
}
